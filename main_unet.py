...
from trainer_old import run_training
...
parser.add_argument("--checkpoint", default="./result/pelvic_unet/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="./result/pelvic_unet/log", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--save_path", default="./result/pelvic_unet", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./result/pelvic_unet/", type=str, help="pretrained checkpoint directory"
)
