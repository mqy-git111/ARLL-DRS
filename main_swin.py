...
parser.add_argument("--checkpoint", default="./result/pelvic_swin_loss/model.pt", help="start training from saved checkpoint")
parser.add_argument("--logdir", default="./result/pelvic_swin_loss/log", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--save_path", default="./result/pelvic_swin_loss", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./result/pelvic_swin_loss/", type=str, help="pretrained checkpoint directory"
)
...
parser.add_argument("--labels",  default=dict(), help="labels")
...
def main():
    ...
    args.labels = read_json_file(json_path)["labels"]
    if args.distributed:
...
def main_worker(gpu, args):
    ...
    if args.squared_dice:
        ...
        dice_loss = DiceCELoss(to_onehot_y=True, softmax=True,lambda_dice = 1.0,lambda_ce = 0.5)
